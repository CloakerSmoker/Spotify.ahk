function collapse(tree) {
  ...
  $("li.toctree-l1").each(function() {
	  if ($(this).children("span.caption-text").hasClass("expandable")) {
		$(this).children("span.caption-text").text($(this).children("span.caption-text").text().substring(0, $(this).children("span.caption-text").text().indexOf(' ')) + ' >')
	  }
  })
...
function expand(tree) {
  ...
  $(tree).children("span.caption-text").text($(tree).children("span.caption-text").text().substring(0, $(tree).children("span.caption-text").text().indexOf(' ')) + ' <')
